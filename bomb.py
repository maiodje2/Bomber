...
webbrowser.open('https://t.me/RAJSHAHIKINGS')

# Print information messages
print("""\033DEVELOPER : BLACK CYBER TEAM 
TELEGRAM  : BLACK CYBER TEAM 
VERSION   : 3.0
PROJECT   : WHATSAPP SPAMMER
FACEBOOK  : BLACK CYBER TEAM 
××××××××××××××××××××××××××××××××××××××××××××""")
...
info_title = '[i][bold green] Spam Request Tool by BLACK CYBER TEAM [/bold green][/i]'
info_message = (
